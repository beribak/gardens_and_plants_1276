...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference("Garden.count") do
      post gardens_url, params: { garden: { garden_banner_url: @garden.garden_banner_url, name: @garden.name } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { garden_banner_url: @garden.garden_banner_url, name: @garden.name } }
